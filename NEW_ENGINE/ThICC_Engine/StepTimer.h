...
namespace DX
{
	...
	public:
		...
		static double TicksToSeconds(uint64_t _ticks) { return static_cast<double>(_ticks) / TicksPerSecond; }
		static uint64_t SecondsToTicks(double _seconds) { return static_cast<uint64_t>(_seconds * TicksPerSecond); }
		...
		void Tick(const TUpdate& _update)
		{
